...
/**
 * Client side of the direct client <-> candidate thread on a long-term job.
 */
class CandidateMessageController extends LongTermJobMessageController
{
    ...
    {
        return $job->client_id === $actor->id && $job->candidate_id !== null;
    }
